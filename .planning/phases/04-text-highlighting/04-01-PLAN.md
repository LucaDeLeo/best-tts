...
must_haves:
  ...
  artifacts:
    ...
    - path: "src/lib/highlight-manager.ts"
      provides: "Core highlight state management and utilities"
      exports: ["getSegmentationLocale", "segmentSentences", "createScrollContext", "destroyScrollContext", "createEmptyHighlightState", "highlightSentence", "clearHighlight", "maybeScrollToSentence"]
...
Also add the following mode-agnostic utility functions that will be used by both overlay and selection modes:
...
```
  ...
  <done>HighlightManager compiles with segmentation, scroll context, and highlight utilities (highlightSentence, clearHighlight, maybeScrollToSentence)</done>
</task>
